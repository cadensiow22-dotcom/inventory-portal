...
export default function UpdateStockModal({
  ...
  {/* Below row: Barcode card + Unlink (NOT inside the flex row) */}
  {openedFromBarcode && barcodeText?.trim() ? (
    <div className="pointer-events-auto relative z-50 rounded-lg border border-amber-200 bg-amber-50 p-3">
